...
URL in the "Privacy practices" tab. `docs/privacy.html` is the GitHub Pages
source for that — serve it from the repo's Pages site, or link the file
directly (`https://github.com/aryanarin/sncommands/blob/main/privacy.html`).
...
- Support email: contact@davagni.eu.org
